...
c b 5 <td><input type=checkbox name=led5 OnClick="submit();" %s>rgb2</td>
c b 4 <td><input type=checkbox name=led4 OnClick="submit();" %s>rgb1</td>
c b 3 <td><input type=checkbox name=led3 OnClick="submit();" %s>rgb0</td>
t <td width="5%"></td>
